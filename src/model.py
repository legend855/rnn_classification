...
class RNN(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_size, pad_id, dataset=None):
        ...
        #self.emb = nn.Embedding.from_pretrained(get_embs(dataset), freeze=False)
    ...
    def forward(self, inputs):
        ...
        # pack inputs
        packed_in = nn.utils.rnn.pack_padded_sequence(embeds, lengths.tolist(), batch_first=True)
        ...
        output_1 = self.fc1(mid_out)
        output_2 = self.fc2(output_1)
        output = self.sfx(output_2)
